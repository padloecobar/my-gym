...
- UI system: Mango Voltage Liquid Glass with hot/cool accent sparks, glass surfaces, and typography utilities (`page-title`, `section-title`) (tokens in `globals.css`, components in `app/ui.css`).
